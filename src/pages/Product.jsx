    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 border-gray-300">
          <p>
            Our e-commerce clothing website offers a wide range of trendy,
            high-quality apparel for every style and occasion. With easy
            navigation, secure payments, and fast delivery, we make online
            shopping simple, stylish, and convenient for everyone.
          </p>
          <p>
            From casual everyday wear to statement pieces, we curate collections
            that blend comfort, affordability, and the latest fashion trends—all
            just a click away.
          </p>
        </div>
      </div>
